...
class Shot: SKSpriteNode {
     ...
     init(textureAtlas: SKTextureAtlas) {
        ...
        self.physicsBody?.categoryBitMask = BitMaskCathegory.shot.rawValue
        self.physicsBody?.collisionBitMask = BitMaskCathegory.enemy.rawValue
        self.physicsBody?.contactTestBitMask = BitMaskCathegory.enemy.rawValue
